...
class TracesApi:
    ...
    @validate_call
    def traces_transform_create(
        self,
        trace_transform_request_request: TraceTransformRequestRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Append selected traces to the agent's accumulating dataset

        Creates a TraceTransformRun and executes it asynchronously: each trace is normalized into a canonical trajectory, validity-gated, deduped on source_trace_id, and appended to the agent's accumulating Dataset(source=traces). The selection must resolve to exactly one agent; pass `agent_id` for agent-less traces. Poll /api/trace-transform-runs/{id}/ for the outcome.

        :param trace_transform_request_request: (required)
        :type trace_transform_request_request: TraceTransformRequestRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._traces_transform_create_serialize(
            trace_transform_request_request=trace_transform_request_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def traces_transform_create_with_http_info(
        self,
        trace_transform_request_request: TraceTransformRequestRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def traces_transform_create_without_preload_content(
        self,
        trace_transform_request_request: TraceTransformRequestRequest,
        _request_timeout: Union[
            None,
    ...
    def _traces_transform_create_serialize(
        self,
        trace_transform_request_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if trace_transform_request_request is not None:
            _body_params = trace_transform_request_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/traces/transform/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
