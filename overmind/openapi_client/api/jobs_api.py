...
class JobsApi:
    ...
    def jobs_list(
        ...
        job_type: Annotated[Optional[StrictStr], Field(description="* `inference` - Inference * `uploaded_outputs_setup` - Uploaded Outputs Setup * `judge_scoring` - Judge Scoring * `prompt_tuning` - Prompt Tuning * `model_backtesting` - Model Backtesting * `connector_sync` - Connector Sync * `langfuse_import` - Langfuse Import")] = None,
        ...
        status: Annotated[Optional[StrictStr], Field(description="* `pending` - Pending * `running` - Running * `completed` - Completed * `partially_completed` - Partially Completed * `failed` - Failed * `cancelled` - Cancelled")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param job_type: * `inference` - Inference * `uploaded_outputs_setup` - Uploaded Outputs Setup * `judge_scoring` - Judge Scoring * `prompt_tuning` - Prompt Tuning * `model_backtesting` - Model Backtesting * `connector_sync` - Connector Sync * `langfuse_import` - Langfuse Import
        :type job_type: str
        ...
        :type search: str
        :param status: * `pending` - Pending * `running` - Running * `completed` - Completed * `partially_completed` - Partially Completed * `failed` - Failed * `cancelled` - Cancelled
        :type status: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
