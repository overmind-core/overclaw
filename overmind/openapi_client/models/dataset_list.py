...
class DatasetList(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "capability", "project", "name", "source", "intent", "surface", "num_datapoints", "metadata", "is_in_use", "verdict", "analysis_status", "created_at", "updated_at"]
