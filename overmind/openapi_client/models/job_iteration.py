...
class JobIteration(BaseModel):
    ...
    capability_code: Optional[StrictStr] = None
    created_at: datetime
    updated_at: Optional[datetime]
    job: UUID
    __properties: ClassVar[List[str]] = ["id", "candidates", "iteration_name", "order", "avg_score", "status", "description", "dimension_scores", "capability_code", "created_at", "updated_at", "job"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobIteration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobIteration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "candidates": [CandidateRow.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None,
            ...
            "capability_code": obj.get("capability_code"),
