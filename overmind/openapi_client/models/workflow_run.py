...
class WorkflowRun(BaseModel):
    ...
    workflow_name: Annotated[str, Field(strict=True, max_length=64)]
    current_block: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "project", "agent", "client_session", "workflow_name", "current_block", "status", "context", "iteration", "error", "created_at", "updated_at", "completed_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_block": obj.get("current_block"),
