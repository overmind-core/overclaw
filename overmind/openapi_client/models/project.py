...
class Project(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "member_count", "member_emails", "name", "slug", "integration_type", "is_active", "settings", "created_at", "updated_at"]
