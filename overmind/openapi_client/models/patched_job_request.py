...
class PatchedJobRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job_type", "prompt_slug", "status", "celery_task_id", "result", "analyzer_model", "num_iterations", "candidates_per_iteration", "data_source", "baseline_score", "best_score", "improvement", "report_markdown", "best_capability_code", "backtest_results", "project", "capability", "triggered_by"]
