...
class JobList(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "project", "capability", "capability_name", "job_type", "prompt_slug", "status", "error", "analyzer_model", "num_iterations", "candidates_per_iteration", "baseline_score", "best_score", "improvement", "created_at", "updated_at"]
