...
class FinetuningJobList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "project", "agent", "dataset", "name", "use_case", "base_model", "status", "group_id", "model_tier", "together_job_id", "output_model_name", "model_weights_location", "progress", "retry_count", "max_retries", "created_at", "updated_at", "started_at", "completed_at"]
