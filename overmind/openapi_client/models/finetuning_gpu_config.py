...
class FinetuningGpuConfig(BaseModel):
    """
    FinetuningGpuConfig
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["gpu_type", "num_gpus", "max_model_len"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinetuningGpuConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinetuningGpuConfig from a dict"""
        if obj is None:
            return None
