...
class CheckpointFile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "size_bytes", "download_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheckpointFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckpointFile from a dict"""
        if obj is None:
            return None
