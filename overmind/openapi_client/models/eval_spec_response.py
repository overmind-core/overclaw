...
class EvalSpecResponse(BaseModel):
    ...
    EvalSpecResponse
    """ # noqa: E501
    capability_description: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["capability_description", "source_path", "input_schema", "output_fields", "structure_weight", "total_points", "tool_config", "tool_usage_weight", "consistency_rules", "optimizable_elements", "fixed_elements"]
