...
class PatchedWorkflowRunRequest(BaseModel):
    """
    ...
    workflow_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = None
    __properties: ClassVar[List[str]] = ["project", "agent", "client_session", "workflow_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedWorkflowRunRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedWorkflowRunRequest from a dict"""
        if obj is None:
            return None
