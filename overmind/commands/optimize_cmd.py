"""overmind optimize — start and monitor server-driven optimization."""
...
from overmind.workflow.runner import run_optimize
...
def build_subparser(subparsers: argparse._SubParsersAction) -> None:
    p = subparsers.add_parser(
        "optimize",
        help="Start a server-driven optimize run",
    )
