"""Extended tests for overmind.optimize.analyzer — LLM-dependent code paths."""
...
class TestGenerateCandidates:
    @patch("overmind.optimize.analyzer._run_codegen")
    @patch("overmind.optimize.analyzer._run_diagnosis")
    ...
    def test_all_fail(self, mock_diag, mock_codegen):
        ...
        with patch("overmind.utils.llm.litellm") as mock_litellm:
            mock_resp = MagicMock()
            mock_resp.choices = [MagicMock()]
