...
class AgentList(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "user", "project", "name", "slug", "description", "agent_path", "model", "structure_weight", "total_points", "tool_usage_weight", "created_at", "updated_at"]
