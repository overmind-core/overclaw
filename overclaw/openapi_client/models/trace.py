...
class Trace(BaseModel):
    ...
    """ # noqa: E501
    id: UUID
    trace_id: Annotated[str, Field(strict=True, max_length=255)]
    ...
    __properties: ClassVar[List[str]] = ["id", "trace_id", "trace_group", "input_data", "output_data", "total_latency_ms", "total_tokens", "total_cost", "score", "error", "start_time", "end_time", "created_at", "user", "agent", "job", "iteration"]
