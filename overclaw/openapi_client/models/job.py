...
class Job(BaseModel):
    ...
    status: Optional[Status1b7Enum] = None
    ...
    user: StrictInt
    agent: UUID
    __properties: ClassVar[List[str]] = ["id", "iterations", "status", "analyzer_model", "num_iterations", "candidates_per_iteration", "data_source", "baseline_score", "best_score", "improvement", "report_markdown", "best_agent_code", "backtest_results", "created_at", "updated_at", "user", "agent"]
