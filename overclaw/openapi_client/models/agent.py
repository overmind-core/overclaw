...
class Agent(BaseModel):
    ...
    user: StrictInt
    project: UUID
    __properties: ClassVar[List[str]] = ["id", "tool_config", "consistency_rules", "optimizable_elements", "fixed_elements", "eval_dataset", "name", "slug", "description", "agent_path", "model", "input_schema", "output_fields", "structure_weight", "total_points", "tool_usage_weight", "created_at", "updated_at", "user", "project"]
