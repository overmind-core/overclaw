...
class TraceCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    trace_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TraceCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TraceCreateRequest from a dict"""
        if obj is None:
            return None
