...
class PatchedSpanRequest(BaseModel):
    """
    PatchedSpanRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["trace", "span_type", "name", "order", "start_time", "end_time", "latency_ms", "metadata", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedSpanRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedSpanRequest from a dict"""
        if obj is None:
            return None
