...
Emitted by `@observe` / `@overmind.task` / `@entry_point` / `@workflow` / `@tool` / `@function` /
...
| `inputs`                                                            | JSON string | decorators when `capture_io=True` (the default)     | Serialised positional + keyword args, including `@task` entry points.                                                                                                                                                                                                                          |
| `outputs`                                                           | JSON string | decorators when `capture_io=True` (the default)     | Serialised return value, including `@task` entry points.                                                                                                                                                                                                                                       |
...
| Key                      | Type   | When present                                              | Meaning                                                                                                                                                                                                                                                                                                                                    |
| ------------------------ | ------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `overmind.behaviour.key` | string | `@overmind.task("key")` or `@overmind.task(key_from=selector)` | The declared task this unit span executes. A fixed key is unchanged; for a shared-entry route, the selector runs before span creation and must return a registered, non-empty key. The key is stamped on the `entry_point` unit span and binds the trace ahead of structural matching. Unknown or stale declarations remain verification failures. |
